...
$env:CRUSH_SAVE_PATH=Join-Path $env:APPDATA ('m5-verify-'+[guid]::NewGuid()+'.json')
...
foreach ($material in @('cardboard','aluminum','tire')) {
 $env:CRUSH_RECORD_DIR=Join-Path $projectRoot "records/m5-review01/$material-regression"
